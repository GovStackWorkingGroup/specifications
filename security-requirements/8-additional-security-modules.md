...
![Example Sequence for Issuing a Token for API Access](../.gitbook/assets/image8.png)

![Example Sequence for Calling an API Microservice via Gatewa](<../.gitbook/assets/image7 (3).png>)
