...
For a specification, see the [Identity and Verification Building Block Specification](https://github.com/GovStackWorkingGroup/specifications/blob/23Q4/security-requirements/broken-reference/README.md).
