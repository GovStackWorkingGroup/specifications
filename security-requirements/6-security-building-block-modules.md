...
Any Building Block must follow the security requirements that are outlined in the Cross-Cutting Requirements section of this document. In addition, specific functionality should be provided by a Security Building Block. An API Gateway should be provided to manage communication between building blocks as well as any incoming requests from external systems. Second, some type of Identity and Access Management or Role-Based Access Control should be implemented as well. The functional requirements for both of these components are described below.
...
**6.1.1 Multiple API Gateway (REQUIRED)**
...
**6.1.2 Standards Based Identity and Access (REQUIRED)**
...
**6.1.3 Identity Store Plugins (REQUIRED)**
...
**6.1.4 API Protection Features (REQUIRED)**
...
**6.1.5 Centralized API Policy Based Access (REQUIRED)**
...
**6.1.6 API Endpoint Transformation (REQUIRED)**
...
**6.1.7 Alternative API Protocols (REQUIRED)**
...
**6.1.8 API Versioning and Lifecycle (REQUIRED)**
...
**6.1.9 API Call Traffic Shaping (RECOMMENDED)**
...
**6.1.10 API Call Rate Limiting (REQUIRED)**
...
**6.1.11 API Call Quotas (RECOMMENDED)**
...
**6.1.12 API Call Logging, Monitoring and Alerts (REQUIRED)**
...
**6.1.13 API Call Analytics (RECOMMENDED)**
...
**6.1.14 API Virtualization (RECOMMENDED)**
...
**6.1.15 API Developer Portal (RECOMMENDED)**
...
**6.1.16 Flexibility in API Deployment Architectures (REQUIRED)**
...
**6.1.17 Advanced DevOps Artifact Deployment (RECOMMENDED)**
...
**6.1.18 File Storage Integration (RECOMMENDED)**
...
**6.1.19 API Monetization (OPTIONAL)**
...
**6.1.20 High Availability (REQUIRED)**
...
**6.1.21 Open Source Based (RECOMMENDED)**
...
**6.2.1 User Administration Tools (REQUIRED)**
...
**6.2.2 Multi-Source Identity Integration (REQUIRED)**
...
**6.2.3 Multi-Source Identity Synchronization (REQUIRED)**
...
**6.2.4 Identity Reconciliation (REQUIRED)**
...
**6.2.5 Self Service Portal and Workflow (REQUIRED)**
...
**6.2.6 Advanced Password Management (REQUIRED)**
...
**6.2.7 User Access Request Management (REQUIRED)**
...
**6.2.9 Orphan Management (REQUIRED)**
...
**6.2.10 Access Certification (REQUIRED)**
...
**6.2.11 Workflow Creation (REQUIRED)**
...
**6.2.12 Custom Workflows (RECOMMENDED)**
...
**6.2.13 Audit and Compliance (REQUIRED)**
...
**6.2.15 Access Management (REQUIRED)**
...
**6.2.16 RBAC Based Authorization (REQUIRED)**
...
**6.2.17 Session Management (REQUIRED)**
...
**6.2.18 Device Registration (REQUIRED)**
...
**6.2.19 Fine Grained Audit Logging (REQUIRED)**
...
**6.2.20 Access Gateway (REQUIRED)**
...
**6.2.21 Legacy SOA Security Features (REQUIRED)**
...
**6.2.22 Web Access Management (REQUIRED)**
...
**6.2.23 Single Sign On (SSO) (REQUIRED)**
...
**6.2.25 Security Token Service (STS) (REQUIRED)**
...
**6.2.26 Role and Attribute Based Access Control (RBAC/ABAC) (REQUIRED)**
